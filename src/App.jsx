...
function App() {
    ...
    const handleDetection = (detection) => {
        setDetections((prevDetections) => [detection, ...prevDetections].slice(0, 20));
    };
            ...
            <main className="dashboard">
                <section className="intro-panel">
                    <div className="intro-copy">
                        ...
                        <p>
                            Local computer vision for intelligent bird monitoring,
                            built to run directly in your browser.
                        </p>
                    </div>
                ...
                <section className="dashboard-grid">
                    <div className="primary-column">
                        <div className="section-title-row">
                            <div>
                                <span className="section-kicker">01 / MONITOR</span>
                                <h2>Live Camera</h2>
                            </div>
                        ...
                        <section className="activity-panel">
                            <div className="section-title-row">
                                <div>
                                    <span className="section-kicker">02 / ACTIVITY</span>
                    ...
                    <aside className="metrics-column">
                        ...
                        <div className="metrics-stack">
                            <StatusPanel detections={detections} status={status} />
                        </div>
                    </aside>
                </section>
            </main>
