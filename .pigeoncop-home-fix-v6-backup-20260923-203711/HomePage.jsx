    ...
    return (
        <div className="pc-home-v5">
            <header className="pc5-nav">
                ...
                >
                    {/* The wordmark already contains the bird + PigeonCop text.
                        Using only this asset prevents the previous logo overlap. */}
                    <img
                        src="/logo-wordmark.png"
                        className="pc5-wordmark"
                        alt="PigeonCop"
                    />
                </button>

                <nav className="pc5-links" aria-label="Primary navigation">
                    <button className="active" onClick={() => scrollTo("top")}>
                        Home
                    </button>
                ...
                <div className="pc5-nav-actions">
                    <a
                        ...
                        rel="noreferrer"
                    >
                        <span className="pc5-gh">●</span>
                        View on GitHub
                    </a>
                    <button className="pc5-primary-btn" onClick={onTestNow}>
                        Test Now <span>→</span>
                    </button>
                </div>
            </header>
            ...
            <main id="top">
                    ...
                    <div className="pc5-copy">
                        ...
                        <div className="pc5-hero-buttons">
                            ...
                            <a
                                ...
                                rel="noreferrer"
                            >
                                <span className="pc5-github-symbol">●</span>
                                View on GitHub
                            </a>
                        </div>
                ...
                <section id="about" className="pc5-cta">
                    <div><span>03 / TRY THE SYSTEM</span><h2>See PigeonCop in action.</h2><p>Open the monitoring console and test Live Camera or a local video file.</p></div>
